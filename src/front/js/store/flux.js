	...
	return {
		...
		actions: {
			private: async () => {
				...
				try {
					let response = await axios.get(`${url}/api/private`, config);
			...
			signup: async (contactData) => {
				...
				try {
					let response = await axios.post(`${url}/api/signup`, data, config);
			...
			login: async (object) => {
				...
				try {
					let response = await axios.post(`${url}/api/login`, data, config);
					/* store = getStore() */
